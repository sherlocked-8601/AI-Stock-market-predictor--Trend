...
data = pd.read_csv('C:/Users/agent/AI-Stock Forecast/stonks.csv',sep=',', index_col='Date', parse_dates=['Date'], date_parser=dateparse).fillna(0)
...
plt.plot(std_dev, color ="black", label = "Standard Deviation", scalex =20, scaley = 20)
...
# Forecast
fc, se, conf = fitted.forecast(117, alpha=0.05)  # 95% conf
